...
std::string
sha256Str(const uint8_t* data, size_t dataLength)
{
    {
      using namespace CryptoPP;
...
/*      using namespace CryptoPP;
      ...
      StringSource(data, dataLength, true, new HashFilter(hash,  new HexEncoder
    		  	  	  	  	  	  	  	  	  	  	  	  	  	  	  	  (new StringSink( value )
    		  	  	  	  	  	  	  	  	  	  	  	  	  	  	  	  ) // HexEncoder
      	  	  	  	  	  	  	  	  	  	  	  	  	  	  	  	  	  ));

      os.write(reinterpret_cast<const char*>(value.c_str()), value.size());
